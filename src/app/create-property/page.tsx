...
export default function CreatePropertyPage() {
  ...
  const activeTab = 'voice'; // Tab fija — Facebook deshabilitado hasta activación futura
      ...
      <div className="px-4 py-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            {/* Tabs Voz / Facebook — descomentar para reactivar importación desde Facebook
            ...
            */}
            ...
            {/* Contenido tab Facebook — descomentar para reactivar
            {activeTab === 'facebook' && (
