            ...
            >
              ...
              >
                ...
                {property.last_facebook_published_at && (
                  <div
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg mb-2 text-xs font-semibold"
                    style={{ backgroundColor: '#EFF6FF', color: '#1877F2' }}
                  >
                    ...
                    {new Date(property.last_facebook_published_at).toLocaleDateString(
