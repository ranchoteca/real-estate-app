...
export default function AttentionPropertiesModal({
  ...
  return (
    <>
      {/* Overlay — fondo opaco igual en todos los tamaños */}
      <div
      ...
      {/*
        Modal container:
        mobile:  inset-x-4, centrado vertical con translate — igual que antes
        tablet+: centrado horizontal y vertical, ancho máximo 520px
      */}
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div
          className="w-full max-w-[520px] max-h-[80vh] flex flex-col rounded-2xl shadow-2xl"
          style={{ backgroundColor: '#FFFFFF' }}
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="p-5 border-b flex-shrink-0" style={{ borderColor: '#E5E7EB' }}>
